...
void KeyboardShortCut::key_callback(GLFWwindow *window, int key, int scancode, int action, int mods) {
...
// TODO: use native API
void KeyboardShortCut::character_callback(GLFWwindow *window, unsigned int codepoint) {
    /*
   // Taken from imgui.h
    if (codepoint <= 127) {
